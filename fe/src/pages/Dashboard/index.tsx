    ...
    <div className="p-8 text-slate-800 min-h-full max-w-[1400px] mx-auto bg-[#f0f4f8]">
      <div className="flex flex-col xl:flex-row gap-6">
        ...
        <div className="flex-1 flex flex-col gap-6">
          ...
          {/* Top: Total Liquidity */}
          <div className="bg-white rounded-[2rem] p-8 lg:p-10 shadow-sm border border-slate-100 flex flex-col relative overflow-hidden">
            <div className="absolute right-0 bottom-0 w-1/2 h-48 pointer-events-none opacity-40 text-[#10b981]">
            ...
            <h2 className="text-[3.5rem] lg:text-[4.5rem] font-bold tracking-tight text-[#0f1f3d] leading-none mb-12">
              {new Intl.NumberFormat('en-US', { style: 'currency', currency: 'USD' }).format(totalBalance)}
            </h2>

            <div className="flex items-end justify-between mt-auto z-10 pt-8 border-t border-slate-100">
              ...
              <button className="text-sm font-bold text-[#0f1f3d] flex items-center hover:underline group">
          ...
          {/* Cash Flow Dynamics */}
          <div className="bg-[#fcfdff] rounded-[2rem] p-8 shadow-sm border border-slate-100">
          ...
          <div className="bg-white rounded-[2rem] p-8 shadow-sm border border-slate-100 mb-8">
            <div className="flex items-center justify-between mb-8">
              ...
              <button className="text-xs font-bold text-[#0f1f3d] flex items-center uppercase tracking-widest hover:underline">
            ...
            <div className="mt-6 flex justify-center border-t border-slate-100 pt-6">
              <button className="text-sm font-bold text-slate-500 hover:text-[#0f1f3d]">Show All Transactions</button>
            </div>
          </div>
        ...
        <div className="w-full xl:w-[350px] flex flex-col gap-6">
          ...
          <div className="bg-[#0f1f3d] rounded-[2rem] p-8 text-white flex flex-col shadow-lg relative overflow-hidden">
             ...
             <button className="w-full bg-white text-[#0f1f3d] rounded-xl font-bold py-3 mt-6 border-none text-sm transition-transform hover:scale-[1.02]">
          ...
          <div className="bg-[#f1f5f9] rounded-[2rem] p-8 border border-slate-200">
             <div className="flex items-center justify-between mb-4">
